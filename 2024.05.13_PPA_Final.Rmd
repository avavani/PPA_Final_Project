...
Overall, our model shows strong generalizability in predicting gentrification across different geographic regions. Running a Spatial Cross Validation finds our MAE to be 0.417, showing relative robustness across the different census tracts.
...
Interestingly, some of the tracts with the highest MAE are also the tracts with the strongest predicted Gentrification Index, once again highlighting our model's weakness when it comes to true positives.
