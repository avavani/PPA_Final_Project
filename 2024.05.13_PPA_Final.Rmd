...
Because We define our Gentrification Index per CT as follows:

<center> GI = (∆ Low Income Proportion) + (Percent Change of Rent) + (Percent Change of Home Value) </center>
...
We assume that if rent has increased between 2012 and 2022, that it will continue to increase, magnifying the gentrification of an area.
