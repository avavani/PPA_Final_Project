...
```{r bmorevis_data, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r bmorevis_mapcol1, message=FALSE, warning=FALSE, include=FALSE}
...
```{r bmorevis_mapcol2, message=FALSE, warning=FALSE, include=FALSE}
...
This feature includes city owned vacant lots and properties with vacant building notices. 

_Universities and Colleges_ 
This feature includes the locations of universities and colleges in Baltimore. 

_Businesses_ 
This feature contains the count of businesses in each community statistical area (CSA), which is a geographic measurement developed by the Baltimore City Planning Department to define neighborhood clusters. 

_Vacant Lots_ 
This feature includes the percentage of vacant lots per CSA. 
...
_Walk Score_
The walk score feature includes the average walk score by CSA. 

I will include more stuff about the features we created from the datasets. - Tina 
```{r bmore_data, message=FALSE, warning=FALSE, cache=TRUE}
